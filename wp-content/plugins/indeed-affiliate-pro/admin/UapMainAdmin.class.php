...
if (!class_exists('UapMainAdmin')) {
	class UapMainAdmin
	{
		...
		private function print_referrals()
		{
			...
			if ($data['subtab'] == 'add_edit') {
				...
				if (!empty($_POST['save']) && !empty($_POST['uap_admin_forms_nonce']) && wp_verify_nonce($_POST['uap_admin_forms_nonce'], 'uap_admin_forms_nonce')) {
					...
					isset($_POST['referral_list']) && $_POST['referral_list'] &&
				...
				$data['filter'] = uap_return_date_filter(
					$data['url-manage'],
					array(
		...
		public function add_style_scripts()
		{
			...
			wp_enqueue_style('uap_main_admin_style', UAP_URL . 'assets/css/main_admin.css', array(), 7.9);
			if ($is_plugin_page) {
				...
				wp_enqueue_style('uap_main_public_style', UAP_URL . 'assets/css/main_public.min.css', array(), 7.9);
			...
			wp_enqueue_media();
			wp_register_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.min.js', ['jquery'], 7.9);
			...
			if ($is_plugin_page) {
				...
				wp_register_script('uap_public', UAP_URL . 'assets/js/public-functions.min.js', ['jquery'], 7.9);
