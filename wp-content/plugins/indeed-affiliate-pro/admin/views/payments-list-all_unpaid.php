<div class="uap-wrapper">
	...
	<form action="<?php echo $data['pay_link'];?>" method="post" id="form_payments">
				<div class="uap-delete-wrapp">
					<input type="submit" value="<?php esc_html_e('Pay selected Referrals', 'uap');?>" name="submit_select_pay" class="button button-primary button-large do-the-payment">
				</div>
				...
				<div class="uap-delete-wrapp">
					<input type="submit" value="<?php esc_html_e('Pay', 'uap');?>" name="submit_select_pay" class="button button-primary button-large do-the-payment">
				</div>
	</form>
	<?php endif;?>
