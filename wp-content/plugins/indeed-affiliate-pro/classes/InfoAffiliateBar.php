...
class InfoAffiliateBar
{
    ...
    {
        wp_enqueue_script( 'uap_iml_popover_js', UAP_URL . 'assets/js/iml.min.js', ['jquery'], 7.4, false );
        wp_enqueue_style( 'uap_iml_popover_css', UAP_URL . 'assets/css/iml-styles.css', [], false, 'all' );
        wp_enqueue_script( 'uap-info-affiliate-bar', UAP_URL . 'assets/js/info-affiliate-bar.js', ['jquery'], 7.4 );
