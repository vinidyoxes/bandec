...
class ProductLinks
{
    ...
    public function registerScripts()
    {
        ...
        wp_enqueue_script( 'uap-public-links-js', UAP_URL . 'assets/js/product_links.js', ['jquery'], false, false );
        wp_enqueue_script( 'indeed-sweet-alert-js', UAP_URL . 'assets/js/sweetalert.js', ['jquery'], 7.5, false );
