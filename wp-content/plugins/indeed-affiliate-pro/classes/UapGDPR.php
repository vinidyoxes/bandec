...
class UapGDPR
{
  ...
  public function doErase($emailAddress='', $page=1)
  {
      ...
      $wpdb->query( $query );
      /// uap_affiliates
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_affiliates WHERE uid=%d;", $this->uid );
      $wpdb->query( $query );
      /// uap_offers_affiliates_reference
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_offers_affiliates_reference WHERE affiliate_id=%d;", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_campaigns
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_campaigns WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_payments
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_payments WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_ranks_history
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_ranks_history WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_coupons_code_affiliates
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_coupons_code_affiliates WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_reports
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_reports WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
      /// uap_ref_links
      $query = $wpdb->prepare( "DELETE FROM {$wpdb->prefix}uap_ref_links WHERE affiliate_id=%d ", $this->affiliateId );
      $wpdb->query( $query );
  ...
  private function getUserMetas()
  {
      ...
      return array(
            ...
            'group_label' => esc_html__('UAP user metas'),
  ...
  private function getAffiliateTableData()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP affiliate data'),
  ...
  private function getOffers()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP offers data'),
  ...
  private function getCampaigns()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP campaigns data'),
  ...
  private function getPayments()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP payments data'),
  ...
  private function getRanksHistory()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP rank history'),
  ...
  private function getCouponsCode()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP coupons code', 'uap'),
  ...
  private function getReports()
  {
      ...
      return array(
          ...
          'group_label' => esc_html__('UAP reports', 'uap'),
