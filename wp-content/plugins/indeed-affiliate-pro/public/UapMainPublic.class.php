...
if (!class_exists('UapMainPublic')){
	class UapMainPublic{
		...
		public function add_style_and_scripts(){
			...
			wp_enqueue_style( 'uap_public_style', UAP_URL . 'assets/css/main_public.min.css', array(), 7.9 );

			wp_enqueue_style( 'uap_templates', UAP_URL . 'assets/css/templates.min.css', array(), 7.9);

			wp_enqueue_script( 'jquery' );

			//wp_register_script( 'uap-public-functions', UAP_URL . 'assets/js/public-functions.js', ['jquery'], 7.9 );
			wp_register_script( 'uap-public-functions', UAP_URL . 'assets/js/public-functions.min.js', ['jquery'], 7.9 );
			...
			wp_register_script( 'uap-jquery_form_module', UAP_URL . 'assets/js/jquery.form.js', ['jquery'], 7.9 );
			wp_register_script( 'uap-jquery.uploadfile', UAP_URL . 'assets/js/jquery.uploadfile.min.js', ['jquery'], 7.9 );
			wp_register_script( 'uap-public-dynamic', UAP_URL . 'assets/js/public.js', ['jquery'], 7.9  );
		}
