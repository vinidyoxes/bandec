...
if (!class_exists('Uap_Woo')) :
	...
	class Uap_Woo extends Referral_Main
	{
		...
		{
			var_dump('registerSubscriptionHooks');
		...
		{
			// dd('make_referral_verified', $order_id, $this);
			var_dump('make_referral_verified', $order_id, $this);
			echo "<br>";
			/*
			 * @param int
			 * @return none
		...
		{
			var_dump('check_for_selected_affiliate');
			/*
			 * @param none
			 * @return none
			 */
		...
		{
			var_dump('insert_affiliate_select');
			/*
			 * @param none
			 * @return none
			 */
		...
		{
			var_dump('checking_affiliate_select');
			/*
			 * @param none
			 * @return none
			 */
		...
		{
			var_dump('create_referral_and_return_renewal_order');
		...
		public function change_status($order_id = 0, $status_transition_from = '', $status_transition_to = '', $that = '')
		{
			...
			var_dump('status_transition_to', $referral_id);
			// dd('status_transition_to', $referral_id);
