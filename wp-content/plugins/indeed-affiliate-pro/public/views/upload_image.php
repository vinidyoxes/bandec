...
<?php wp_enqueue_script( 'uap-image_croppic', UAP_URL . 'assets/js/image_croppic.js', ['jquery'], 7.4 );?>
<?php wp_enqueue_script( 'uap-public-upload-image', UAP_URL . 'assets/js/public-upload-image.js', ['jquery'], 7.4 );?>
<?php
