...
class Triply_BABE_Elementor_Itemcontent_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Item Content', 'triply' );
	}
	...
	protected function render() {
        ...
        get_template_part('template-parts/booking/single/content');
        echo '</div>';
