...
class Triply_BABE_Elementor_Itemmaxguests_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Item Max Guests', 'triply');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Max People', 'triply')
            ]
        );
